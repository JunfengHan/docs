...
![函数计算](../img/ali_serverless_flow.png)
...
![应用构建方式对比](../img/compare_serverless.png)
...
![函数计算工作流程](../img/aliServerless_flow.png)
...
![函数计算请求和调用链路](../img/ali_serverless_flow.png)
...
![API网关同步调用计算函数](../img/serverless_sync_invoke.png)
...
![异步同步调用计算函数](../img/serverless_async_invoke.png)

_函数执行过程示例：_

![函数执行过程](../img/serverless_execute_flow.png)
...
![计算函数使用流程](../img/ali_function_flow.png)
...
![创建服务与函数](../img/serverless_start_createServer.png)

_2.选择函数类型_

![选择函数类型](../img/serverless_ali_createFunc.png)
...
![入口函数](../img/serverless_ali_funcIndex.png)
...
![函数实例](../img/serverless_ali_funcExample.png)
...
![serverless应用耗时](../img/serverless_ali_performance.png)
