...
![语言类型分类](../_media/js_deep_languageType.png)
...
![js存储空间](../_media/js_deep_dataStore.png)
...
- 2. 栈空间
  ...
  ![调用栈](../_media/js_deep_stack.png)

- 3. 堆空间

  执行到第 4 行（即：var c = { name: "极客时间" };）时的调用栈如下：

  ![调用栈+堆](../_media/js_deep_heap.png)
...
![js执行过程](../_media/js_deep_jsExe.png)
...
![js执行过程详细流程](../_media/js_deep_exeFlow.png)
...
![js调用栈](../_media/js_deep_stackFlow.png)

**Step2: 执行赋值**

![js调用栈2](../_media/js_deep_stackFlow2.png)
...
![js调用栈3](../_media/js_deep_stackFlow3.png)
...
![js调用栈4](../_media/js_deep_stackFlow4.png)
...
![执行上下文的组成](../_media/js_deep_contextComponent.png)
...
![执行上下文示例1](../_media/js_deep_context1.png)
...
![执行上下文示例2](../_media/js_deep_context2.png)
...
![执行上下文示例3](../_media/js_deep_context3.png)

4. 执行代码到块结束（即：第 11 行）

此时块中的代码(即：{}中的代码)已经执行完，其内部定义的变量就会**从词法环境的栈顶弹出**。

![执行上下文示例4](../_media/js_deep_context4.png)
...
![执行上下文切换](../_media/js_deep_context.png)
...
![变量查找过程](../_media/js_deep_scope2.png)
...
![词法作用域](../_media/js_deep_scope3.png)
...
![闭包1](../_media/js_deep_closure1.png)

2. foo() 执行结束时的调用栈

![闭包2](../_media/js_deep_closure2.png)
...
![闭包3](../_media/js_deep_closure3.png)

此时，打个断点看一下代码的执行情况：

![闭包4](../_media/js_deep_closure4.png)
